...
"""
    ...
    async def _check_portfolio_diversification_before_trade(self, symbol: str, signal_data: Dict) -> Optional[float]:
        ...
        try:
            ...
            SYMBOL_LIMITS = {
                'ADAUSDT': 20.0,  # ADA máximo 20% del portafolio
                'BTCUSDT': 30.0,  # BTC máximo 30% del portafolio
                'ETHUSDT': 30.0,  # ETH máximo 30% del portafolio
                'BNBUSDT': 25.0,  # BNB máximo 20% del portafolio
                'XRPUSDT': 20.0,  # XRP máximo 20% del portafolio
                'DOTUSDT': 30.0,  # DOT máximo 20% del portafolio
                'SOLUSDT': 20.0,  # SOL máximo 20% del portafolio (nuevo par activado)
                'POLUSDT': 20.0  # LINK máximo 20% del portafolio (nuevo par activado)
            }

            # ✅ PRIORIZACIÓN: Orden de preferencia para señales simultáneas
            PRIORITY_ORDER = ['BTCUSDT', 'ETHUSDT', 'BNBUSDT', 'XRPUSDT', 'DOTUSDT', 'ADAUSDT', 'SOLUSDT', 'POLUSDT']
