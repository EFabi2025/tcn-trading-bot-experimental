...
2. LÍNEA DE COMANDOS CON REGÍMENES EQUILIBRADOS:
   python tcn_adaptative_trainer_v2.py --balanced_regimes --regime_method manual --samples_per_regime 500

3. ENTRENAMIENTO COMPLETO CON REGÍMENES EQUILIBRADOS:
   python tcn_adaptative_trainer_v2.py --non_interactive --balanced_regimes --regime_method auto --pairs BTCUSDT ETHUSDT
